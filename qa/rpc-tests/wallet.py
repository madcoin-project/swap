...
#   c) node1 mines 32 blocks, so now node 0 has 500000MDC, node 1 has 4250MDC, node2 has none.
#   d) node0 sends 601 MDC to node2, in two transactions (301 MDC, then 300 MDC).
