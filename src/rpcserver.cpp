...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Madcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Madcoin features */
        {"madcoin", "masternode", &masternode, true, true, false},
        {"madcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"madcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"madcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"madcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"madcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"madcoin", "startmasternode", &startmasternode, true, true, false},
        {"madcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"madcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"madcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"madcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"madcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"madcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"madcoin", "mnbudget", &mnbudget, true, true, false},
        {"madcoin", "preparebudget", &preparebudget, true, true, false},
        {"madcoin", "submitbudget", &submitbudget, true, true, false},
        {"madcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"madcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"madcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"madcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"madcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"madcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"madcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"madcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"madcoin", "mnsync", &mnsync, true, true, false},
        {"madcoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
