...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MDC address"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Madcoin Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Madcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MDC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MDC addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Madcoin Core help message to get a list with possible Madcoin command-line options"));
