...
In order to support loading of multiple wallets in madcoin-qt, a few changes in the UI architecture will be needed.
...
----------------------
madcoin.cpp is the entry point into madcoin-qt, and as such, will require some minor modifications to provide hooks for
