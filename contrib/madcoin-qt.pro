...
RESOURCES += src/qt/madcoin.qrc src/qt/madcoin_locale.qrc

TRANSLATIONS += src/qt/locale/madcoin_bg.ts \
                src/qt/locale/madcoin_de.ts \
                src/qt/locale/madcoin_en.ts \
                src/qt/locale/madcoin_es.ts \
                src/qt/locale/madcoin_fi.ts \
                src/qt/locale/madcoin_fr.ts \
                src/qt/locale/madcoin_it.ts \
                src/qt/locale/madcoin_ja.ts \
                src/qt/locale/madcoin_pl.ts \
                src/qt/locale/madcoin_pt.ts \
                src/qt/locale/madcoin_ru.ts \
                src/qt/locale/madcoin_sk.ts \
                src/qt/locale/madcoin_sv.ts \
                src/qt/locale/madcoin_vi.ts \
                src/qt/locale/madcoin_zh_CN.ts \
                src/qt/locale/madcoin_zh_TW.ts
