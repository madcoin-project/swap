...
Setup
---------
Configuring the github-merge tool for the Madcoin repository is done in the following way:

    git config githubmerge.repository madcoin/madcoin
...
A script to optimize png files in the Madcoin
